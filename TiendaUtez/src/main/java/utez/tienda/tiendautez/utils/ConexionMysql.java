...
public class ConexionMysql {
   ...
   // final String DBNAME= "utezshop", USERNAME = "root", PASSWORD = "Abejercito22?",   TIMEZONE="America/Mexico_City", USEESL = "false", PUBLICKEY = "true";
    final String
//           POINT="generaldatabasealexxjoel.cqlrgjtpjtuz.us-east-1.rds.amazonaws.com",
           POINT="localhost",
           DBNAME= "utezshop",
//           USERNAME = "admin",
           USERNAME = "root",
    //           PASSWORD = "databaseJoel",
           PASSWORD = "alejandro",
        TIMEZONE="America/Mexico_City", USEESL = "false", PUBLICKEY = "true";


    public Connection getConexion(){
        String dataSource = String.format("jdbc:mysql://"+POINT+"/%s?user=%s&password=%s&serverTimezone=%s&useSSL=%s&allowPublicKeyRetrieval=%s",
